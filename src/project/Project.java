...
class student{
    ...
    public int removeStudent(int studentID){
        if (ISexisted(studentID)){
            ...
            Node current = student.sc; // remove registration of the student
            while(current != null){
            ...
            Node tmp = head;   //remove student itself
            if(tmp.next == null){
                head = null;
                return tmp.sID;
            }
